...
$sql =  " ";
			$sql =  " SELECT  bank_name,sucursale,bank_address1,account_number,bank_number,bank_postcode , bank_CityName,bank_country,bank_phone,identity_number,message,bank_cgv,identity_img,billing_cycles FROM admin_gmahexpress.ko_message WHERE id_customer = '".$id_customer."'  AND id_order='".$id_order."' " ;

   $bank_datas = Db::getInstance()->executeS( $sql  );
		if ( $bank_datas ) 
			{
			//	var_dump(  ' REQUEST: ',$sql,'<br/>DATAS: ',$bank_datas ,'<br/>$id_order: ',$id_order);exit;
			 ...
			 'sucursale' =>$bank_datas[0]['sucursale']  ,  'bank_address1' =>$bank_datas[0]['bank_address1'] ,   'bank_postcode' =>$bank_datas[0]['bank_postcode'] ,  'bank_CityName' =>$bank_datas[0]['bank_CityName'] ,
			  'bank_country' =>$bank_datas[0]['bank_country'] ,  'bank_phone' =>$bank_datas[0]['bank_phone'] , 'identity_number' =>$bank_datas[0]['identity_number'] ,  'message' =>$bank_datas[0]['message'] , 'bank_cgv' =>$bank_datas[0]['bank_cgv']  , 'identity_img' =>$bank_datas[0]['identity_img']  , 'billing_cycles' =>$bank_datas[0]['billing_cycles'] ) );
			}
/* **************************************************************************************************************************************************************** */
