			...
			if( file_exists ( $_FILES['identity_img']['tmp_name'] ) ) // image was uploaded
					{		 
						...
						if (  move_uploaded_file( $_FILES['identity_img']['tmp_name'], $uploadrealfile )  ) // copy the tmp file to the real path 
					 	...
					 	$_SESSION['identity_img']['tmp_name'] =   $_FILES['identity_img']['tmp_name'];
			   	   	   ...
			   	   	   {	
			   	   	   	 ...
			   	   	   	 $this->context->smarty->assign( 
									 array( 	'identity_img_name' => str_replace ( $id_customer.'_' , '' , basename( $_SESSION['identity_img'])  ),
									 	 	...
									 	 	'identity_img_real_name' => 	$_SESSION['identity_img']
									  )  );
					...
					//var_dump(  ' REQUEST: ',$sql,$img_exists[0]['identity_img'] );exit;
						...
						if ( $img_exists[0]['identity_img']  !== '' ) 
								{	
									 ...
									 $_SESSION['uploadrealfile'] = $img_exists[0]['identity_img'];			
									    	return( TRUE );	  
			    					}
			    		//var_dump(  ' REQUEST: ',$sql,$img_exists[0]['identity_img'] );exit;	
