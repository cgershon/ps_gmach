            ...
            <fieldset>
                ...
                {if isset($newsletter) && $newsletter}
                    <div class="" align="right">
                     ...
                     {l s='Sign up for our newsletter!'}<input type="checkbox" id="newsletter" name="newsletter" value="1" {if isset($smarty.post.newsletter) && $smarty.post.newsletter == 1} checked="checked"{/if} align="right"/>     
                ...
                {if isset($optin) && $optin}
                    <div class="" align="right">
                        <label for="optin">
                      {l s='Receive special offers from our partners!'}<input type="checkbox" name="optin" id="optin" value="1" {if isset($smarty.post.optin) && $smarty.post.optin == 1} checked="checked"{/if} align="right" />
