...
<div class="addresses clearfix">
	<div class="row">
		<div class="col-xs-12 col-sm-6">
			<div class="address_delivery select form-group selector1">
				<center><label for="id_address_delivery" dir="rtl" style="text-align:right">
            {if $cart->isVirtualCart()}{l s='Choose a billing address:'}{else}{l s='Choose a delivery address:'}{/if}</label></center>
	...
	{if !$opc}
		<div id="ordermsg" class="form-group">
			...
			<textarea class="" cols="70" rows="10" name="message">{if isset($oldMessage)}{$oldMessage}{/if}</textarea>
		</div>
	{/if}
...
{capture}
<h3 class="page-subheading">{l s='Your billing address' js=1}</h3>{/capture}
