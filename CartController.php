...
class CartControllerCore extends FrontController
{
    ...
    {
           $this->del_cart();    // YGPC ADDED to avoid multi loans 
    ...
    /* ******************************************** permet d interdire plusieurs prets ************************************* */
    
    public function del_cart()
    {
    	
    	   $del_result =  Db::getInstance()->executeS( "DELETE FROM `ko_cart_product` WHERE ko_cart_product.id_cart = ' ". (int)$this->context->cart->id ." ' " );
	 //	$del_result =  $this->processDeleteProductInCart();
    	 // var_dump(   $del_result , (int)$this->context->cart->id );
    }
