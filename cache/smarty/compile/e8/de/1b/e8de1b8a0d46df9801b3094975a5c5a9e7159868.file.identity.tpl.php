<?php /* Smarty version Smarty-3.1.19, created on 2016-07-12 10:56:21
         compiled from "/var/www/vhosts/konim.biz/ps_gmach/themes/default-bootstrap/identity.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4776902125784a2a55e44d1-96498088%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e8de1b8a0d46df9801b3094975a5c5a9e7159868' => 
    array (
      0 => '/var/www/vhosts/konim.biz/ps_gmach/themes/default-bootstrap/identity.tpl',
      1 => 1467141844,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4776902125784a2a55e44d1-96498088',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5784a2a575fa35_05479915',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5784a2a575fa35_05479915')) {function content_5784a2a575fa35_05479915($_smarty_tpl) {?>
...
" />
                ...
                <div class="form" align="right">
                    ...
                    <div class="" align="right">
                            ...
                            <select name="days" id="days" class="form-control"  style="width:100px;">
                                <option value="">-</option>
...
&nbsp;&nbsp;</option>
                            ...
                            <select id="months" name="months" class="form-control" style="width:100px;">
                                <option value="">-</option>
                                <?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['v']->_loop = false;
 $_smarty_tpl->tpl_vars['k'] = new Smarty_Variable;
...
&nbsp;</option>
                            ...
                            <select id="years" name="years" class="form-control" style="width:100px;">
                                <option value="">-</option>
                                <?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['v']->_loop = false;
...
<input type="checkbox" id="newsletter" name="newsletter" value="1" <?php if (isset($_POST['newsletter'])&&$_POST['newsletter']==1) {?> checked="checked"<?php }?> align="right"/>     
...
<input type="checkbox" name="optin" id="optin" value="1" <?php if (isset($_POST['optin'])&&$_POST['optin']==1) {?> checked="checked"<?php }?> align="right" />
