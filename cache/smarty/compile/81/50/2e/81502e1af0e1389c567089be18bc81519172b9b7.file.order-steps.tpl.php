<?php /* Smarty version Smarty-3.1.19, created on 2016-07-11 19:28:08
         compiled from "/var/www/vhosts/konim.biz/ps_gmach/themes/default-bootstrap/order-steps.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14630677495783c918559852-40743881%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '81502e1af0e1389c567089be18bc81519172b9b7' => 
    array (
      0 => '/var/www/vhosts/konim.biz/ps_gmach/themes/default-bootstrap/order-steps.tpl',
      1 => 1464810316,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14630677495783c918559852-40743881',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5783c91861ae93_46873957',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5783c91861ae93_46873957')) {function content_5783c91861ae93_46873957($_smarty_tpl) {?>
...
">
	...
	<li class="<?php if ($_smarty_tpl->tpl_vars['current_step']->value=='shipping') {?>step_current<?php } else { ?><?php if ($_smarty_tpl->tpl_vars['current_step']->value=='payment') {?>step_done step_done_last<?php } else { ?>step_todo<?php }?><?php }?> four">
		...
		<a href="<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['multi_shipping']->value) {?><?php echo "&multi-shipping=";?><?php echo (string)$_smarty_tpl->tpl_vars['multi_shipping']->value;?><?php }?><?php $_tmp8=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,((string)Smarty::$_smarty_vars['capture']['url_back'])."&step=2".$_tmp8), ENT_QUOTES, 'UTF-8', true);?>
">
