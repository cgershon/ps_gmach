...
class GmachimControllerCore extends FrontController
{
    public $php_self = 'gmachim';
...
*/
      ...
      //  $this->context->smarty->assign('display_store', Configuration::get('PS_STORES_DISPLAY_GMACHIM'));

        $this->setTemplate(_PS_THEME_DIR_.'gmachim.tpl');
    }
}
