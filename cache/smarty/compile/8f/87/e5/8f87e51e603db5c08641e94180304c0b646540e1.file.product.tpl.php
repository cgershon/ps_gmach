<?php /* Smarty version Smarty-3.1.19, created on 2016-07-11 19:26:31
         compiled from "/var/www/vhosts/konim.biz/ps_gmach/themes/default-bootstrap/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16662576655783c8b75fb7f5-04232160%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8f87e51e603db5c08641e94180304c0b646540e1' => 
    array (
      0 => '/var/www/vhosts/konim.biz/ps_gmach/themes/default-bootstrap/product.tpl',
      1 => 1467968772,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16662576655783c8b75fb7f5-04232160',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5783c8b80254b9_25640410',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5783c8b80254b9_25640410')) {function content_5783c8b80254b9_25640410($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/vhosts/konim.biz/ps_gmach/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_math')) include '/var/www/vhosts/konim.biz/ps_gmach/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_cycle')) include '/var/www/vhosts/konim.biz/ps_gmach/tools/smarty/plugins/function.cycle.php';
if (!is_callable('smarty_function_counter')) include '/var/www/vhosts/konim.biz/ps_gmach/tools/smarty/plugins/function.counter.php';
?>
...
<?php if ($_smarty_tpl->tpl_vars['product']->value->quantity<=0) {?><?php if ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value&&$_smarty_tpl->tpl_vars['allow_oosp']->value) {?><?php echo $_smarty_tpl->tpl_vars['product']->value->available_later;?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'This product is no longer in stock'),$_smarty_tpl);?>
<?php }?>
<?php } elseif ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value) {?><?php echo $_smarty_tpl->tpl_vars['loan_available']->value;?>
<?php }?></span> 
			</p>
...
<Center>
<strong>
  <?php echo smartyTranslate(array('s'=>$_smarty_tpl->tpl_vars['Payment']->value),$_smarty_tpl);?>
...
<Div>  
 ...
 // INIT WITH 1 payment 
   ...
   $.post( 'billing_cycle.php' , { Nb:1 , token: '<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
' ,step:'BILLING_CYCLE'  } );
...
<script type= "text/javascript">
 ...
 //PaymentsTitle.legend|escape:'html':'UTF-8' ;  
  ...
  function myPayments() {
   ...
   // alert(  Nb )    ;  
    if( Nb == 1)
     var PaymentsTitle =  'תשלום' ;  

    else
     var PaymentsTitle =" תשלומים";
    
  document.getElementById("Payments").innerHTML = PaymentsTitle ;

      $.post( 'billing_cycle.php' , { Nb: Nb, token:'<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
' , step:'BILLING_CYCLE' } );
   // <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getModuleLink('bestkit_psubscription','front',array('set_billing_cycle'=>true),true), ENT_QUOTES, 'UTF-8', true);?>
