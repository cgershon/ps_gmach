<?php /* Smarty version Smarty-3.1.19, created on 2016-07-11 19:26:31
         compiled from "/var/www/vhosts/konim.biz/ps_gmach/themes/default-bootstrap/modules/blockcms/blockcms.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5783c8b7360d96_95445026',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5783c8b7360d96_95445026')) {function content_5783c8b7360d96_95445026($_smarty_tpl) {?>
...
">
			...
			<?php }?>
			<?php if (isset($_smarty_tpl->tpl_vars['show_best_sales']->value)&&$_smarty_tpl->tpl_vars['show_best_sales']->value&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value&&false) {?><!-- YGPC ADDED  FALSE-->
				<li class="item">
...
">
			...
			<?php }?>
			<?php if (isset($_smarty_tpl->tpl_vars['display_stores_footer']->value)&&$_smarty_tpl->tpl_vars['display_stores_footer']->value&&false) {?><!-- YGPC ADDED  FALSE-->
				<li class="item">
					<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('stores'), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Our stores','mod'=>'blockcms'),$_smarty_tpl);?>
">
...
">
			...
			<?php }?>
			<?php  $_smarty_tpl->tpl_vars['cmslink'&&false] = new Smarty_Variable; $_smarty_tpl->tpl_vars['cmslink'&&false]->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['cmslinks']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['cmslink'&&false]->key => $_smarty_tpl->tpl_vars['cmslink'&&false]->value) {
$_smarty_tpl->tpl_vars['cmslink'&&false]->_loop = true;
?>
...
">
	...
	<section class="bottom-footer col-xs-12">
		<div>
			<?php echo '/*%%SmartyNocache:3387004125783c8b7221430-87387527%%*/<?php echo smartyTranslate(array(\'s\'=>\'[1] %3$s %2$s - Software by %1$s [/1]\',\'mod\'=>\'blockcms\',\'sprintf\'=>array(\'YGPC™\',date(\'Y\'),\'©\'),\'tags\'=>array(\'<a class="_blank" href="http://www.konim.biz">\')),$_smarty_tpl);?>
/*/%%SmartyNocache:3387004125783c8b7221430-87387527%%*/';?>
